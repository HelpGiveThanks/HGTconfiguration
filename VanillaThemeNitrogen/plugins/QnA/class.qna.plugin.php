...
NOTE: David Matson altered this plugin coping and pasting code changes found in the helpful forum post The Big Button option part A: http://vanillaforums.org/discussion/26902/some-adjustments-to-more-clearly-see-ask-a-question-in-q-a-1-2-1-new-discussion-button. In addition to these code changes, two additional lines of code also copied from the above post must be added to the config.php file to add the big button as specified in this remix's readme.md file.
