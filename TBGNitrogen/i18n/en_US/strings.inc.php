<?php
	...
	$strings['Access to this issue is restricted'] = 'Access to this record is restricted';
	...
	$strings['Add a new issue type'] = 'Add a new record type';
	...
	$strings['Add more information to your issue'] = 'Add more information to your record';
	...
	$strings['Affected issues'] = 'Affected records';
	...
	$strings['Allow issues to be reported'] = 'Allow records to be created';
	...
	$strings['Always post comments when an issue is updated'] = 'Always post comments when a record is updated';
	...
	$strings['An error occured when relating issues: %error%'] = 'An error occured when relating records: %error%';
	...
	$strings['Any issues created will be set to this issuetype, and its first workflow step will be applied'] = 'Any records created will be set to this recordtype, and its first workflow step will be applied';
	$strings['Any issues you create will be related to %related_issue_title%'] = 'Any records you create will be related to %related_issue_title%';
	...
	$strings['Assigned to team - which team is an issue assigned to'] = 'Assigned to team - which team is a record assigned to';
	$strings['Assigned to user'] = 'Assigned to user';
	$strings['Assigned to user - which user is an issue assigned to'] = 'Assigned to user - which user is a record assigned to';
	$strings['Assigned users'] = 'Assigned users';
	$strings['Assignee'] = 'Assignee';
	$strings['Assignee changed: %text%'] = 'Assignee changed: %text%';
	$strings['Assign issue to %user%'] = 'Assign record to %user%';
	$strings['Assign the issue to a user'] = 'Assign the record to a user';
	$strings['Assign the issue to the current user'] = 'Assign the record to the current user';
	$strings['Assign this issue'] = 'Assign this record';
	...
	$strings['Attach a link to this issue'] = 'Attach a link to this record';
	...
	$strings['Attach one or more file(s) to this issue'] = 'Attach one or more file(s) to this record';
	...
	$strings['Available issue fields'] = 'Available record fields';
	$strings['Available issue types'] = 'Available record types';
	...
	$strings['Built-in issue fields'] = 'Built-in record fields';
	...
	$strings['Can access the project issues search page'] = 'Can access the project records search page';
	...
	$strings['Can add components to list of affected components for any issues'] = 'Can add components to list of affected components for any records';
	$strings['Can add components to list of affected components for issues reported by the user'] = 'Can add components to list of affected components for records reported by the user';
	$strings['Can add editions to list of affected editions for any issues'] = 'Can add editions to list of affected editions for any records';
	$strings['Can add editions to list of affected editions for issues reported by the user'] = 'Can add editions to list of affected editions for records reported by the user';
	$strings['Can add files to and remove own files from any issues'] = 'Can add files to and remove own files from any records';
	$strings['Can add files to and remove own files from issues reported by the user'] = 'Can add files to and remove own files from records reported by the user';
	$strings['Can add links to any issues'] = 'Can add links to any records';
	$strings['Can add links to issues reported by the user'] = 'Can add links to records reported by the user';
	$strings['Can add milestones/sprints on the project planning page'] = 'Can add milestones/sprints on the project planning page';
	$strings['Can add new issues/tasks/stories to the backlog on the project planning page'] = 'Can add new problems/tasks/stories to the backlog on the project planning page';
	$strings['Can add related issues to other issues'] = 'Can add related records to other records';
	$strings['Can add releases / versions to list of affected versions for any issues'] = 'Can add releases / versions to list of affected versions for any records';
	$strings['Can add releases / versions to list of affected versions for issues reported by the user'] = 'Can add releases / versions to list of affected versions for records reported by the user';
	$strings['Can add/remove extra information and link issues (edition, component, release, links and files) to issues'] = 'Can add/remove extra information and link records (edition, component, release, links and files) to records';
	$strings['cancel'] = 'cancel';
	$strings['Cancel'] = 'Cancel';
	$strings['Cancel and close this pop-up'] = 'Cancel and close this pop-up';
	$strings['Cancel invitation'] = 'Cancel invitation';
	$strings['Can change custom field "%field_name%" for any issues'] = 'Can change custom field "%field_name%" for any records';
	$strings['Can change custom field "%field_name%" for issues reported by the user'] = 'Can change custom field "%field_name%" for records reported by the user';
	$strings['Can change custom field values for any issues'] = 'Can change custom field values for any records';
	$strings['Can change custom field values for issues reported by the user'] = 'Can change custom field values for records reported by the user';
	$strings['Can change own password'] = 'Can change own password';
	$strings['Can close and reopen issues reported by the user'] = 'Can close and reopen records reported by the user';
	$strings['Can close any issues'] = 'Can close any records';
	$strings['Can close issues reported by the user'] = 'Can close records reported by the user';
	$strings['Can create issues, edit basic information on issues reported by the user and close/re-open them'] = 'Can create records, edit basic information on records reported by the user and close/re-open them';
	$strings['Can create new issues'] = 'Can create new records';
	...
	$strings['Can delete, close, reopen and update any issue details and progress'] = 'Can delete, close, reopen and update any record details and progress';
	$strings['Can delete issues'] = 'Can delete records';
	$strings['Can delete own comments'] = 'Can delete own comments';
	$strings['Can edit all comments'] = 'Can edit all comments';
	$strings['Can edit any issue description'] = 'Can edit any record description';
	$strings['Can edit any issue steps to reproduce'] = 'Can edit any record steps to reproduce';
	$strings['Can edit any issue title'] = 'Can edit any record title';
	$strings['Can edit issue assigned_to'] = 'Can edit record assigned_to';
	$strings['Can edit issue category'] = 'Can edit record category';
	$strings['Can edit issue description on issues reported by the user'] = 'Can edit record description on records reported by the user';
	$strings['Can edit issue owned by'] = 'Can edit record owned by';
	$strings['Can edit issue percent complete'] = 'Can edit record percent complete';
	$strings['Can edit issue posted by'] = 'Can edit record posted by';
	$strings['Can edit issue priority'] = 'Can edit record priority';
	$strings['Can edit issue reproducability'] = 'Can edit record reproducability';
	$strings['Can edit issue resolution'] = 'Can edit record resolution';
	$strings['Can edit issue severity'] = 'Can edit record severity';
	$strings['Can edit issue status'] = 'Can edit record status';
	$strings['Can edit issue title on issues reported by the user'] = 'Can edit record title on records reported by the user';
	...
	$strings['Can edit steps to reproduce on issues reported by the user'] = 'Can edit steps to reproduce on records reported by the user';
	$strings['Can edit the wiki lefthand menu'] = 'Can edit the wiki lefthand menu';
	$strings['Can edit title and description on any issues'] = 'Can edit title and description on any records';
	$strings['Can edit title and description on issues reported by the user'] = 'Can edit title and description on records reported by the user';
	$strings['Can estimate issues'] = 'Can estimate records';
	...
	$strings['Cannot delete issuetype scheme'] = 'Cannot delete recordtype scheme';
	...
	$strings['Cannot find the issue specified'] = 'Cannot find the record specified';
	$strings['Cannot find the project specified'] = 'Cannot find the project specified';
	$strings['Can post comments'] = 'Can post comments';
	$strings['Can (re-)assign issues/tasks/stories to milestones/sprints on the project planning page'] = 'Can (re-)assign problems/tasks/stories to milestones/sprints on the project planning page';
	$strings['Can remove any attachments from any issues'] = 'Can remove any attachments from any records';
	$strings['Can remove any attachments from issues reported by the user'] = 'Can remove any attachments from records reported by the user';
	$strings['Can re-open any issues'] = 'Can re-open any records';
	$strings['Can re-open issues reported by the user'] = 'Can re-open records reported by the user';
	$strings['Can report issues:'] = 'Can report records:';
	$strings['Can search for issues'] = 'Can search for records';
	$strings['Can search for issues and create saved searches'] = 'Can search for records and create saved searches';
	...
	$strings['Can see issues reported by other users'] = 'Can see records reported by other users';
	$strings['Can see issues reported by users in the same group'] = 'Can see records reported by users in the same group';
	...
	$strings['Can set issue milestone'] = 'Can set record milestone';
	$strings['Can spend time working on issues'] = 'Can spend time working on records';
	$strings['Can toggle issue access between restricted and public'] = 'Can toggle record access between restricted and public';
	$strings['Can vote for issues'] = 'Can vote for records';
	...
	$strings['Category - which category an issue is in'] = 'Category - which category a record is in';
	...
	$strings['Change issue owner'] = 'Change record owner';
	...
	$strings['Choose a category for this issue'] = 'Choose a category for this record';
	$strings['Choose a different workflow'] = 'Choose a different workflow';
	$strings['Choose a how often you can reproduce this issue'] = 'Choose a how often you can reproduce this problem';
	$strings['Choose a resolution for this issue'] = 'Choose a resolution for this problem';
	$strings['Choose a severity for this issue'] = 'Choose a severity for this problem';
	$strings['Choose a status for this issue'] = 'Choose a status for this record';
	...
	$strings['Choose the component affected by this issue'] = 'Choose the component affected by this record';
	$strings['Choose the milestone of this issue'] = 'Choose the milestone of this record';
	$strings['Choose the priority of this issue'] = 'Choose the priority of this record';
	...
	$strings['Clear issue assignee'] = 'Clear record assignee';
	$strings['Clear issue percent completed'] = 'Clear record percent completed';
	$strings['Clear issue priority'] = 'Clear record priority';
	$strings['Clear issue reproducability'] = 'Clear problem reproducability';
	$strings['Clear issue resolution'] = 'Clear problem resolution';
	...
	$strings['Click the link to visit the reported issue'] = 'Click the link to visit the created record';
	$strings['Click the star to toggle whether you want to be notified whenever this issue updates or changes'] = 'Click the star to toggle whether you want to be notified whenever this record updates or changes';
	...
	$strings['Click to change issue type'] = 'Click to change record type';
	...
	$strings['Click to enter time spent on this issue'] = 'Click to enter time spent on this record';
	$strings['Click to estimate this issue'] = 'Click to estimate this record';
	...
	$strings['CLI issue tracker URL'] = 'CLI record tracker URL';
	...
	$strings['Closed issues for %project_name%'] = 'Closed records for %project_name%';
	$strings['Closed issues for this project'] = 'Closed records for this project';
	$strings['Closed issues per category'] = 'Closed records per category';
	$strings['Closed issues per priority level'] = 'Closed records per priority level';
	$strings['Closed issues per reproducability level'] = 'Closed records per reproducability level';
	$strings['Closed issues per resolution'] = 'Closed records per resolution';
	$strings['Closed issues per status type'] = 'Closed records per status type';
	...
	$strings['Component <b>%component%</b> is no longer affected by this issue'] = 'Component <b>%component%</b> is no longer affected by this record';
	$strings['Component <b>%component%</b> is now affected by this issue'] = 'Component <b>%component%</b> is now affected by this record';
	$strings['Component <b>%component%</b> is now confirmed for this issue'] = 'Component <b>%component%</b> is now confirmed for this record';
	$strings['Component <b>%component%</b> is now %status%'] = 'Component <b>%component%</b> is now %status%';
	$strings['Component <b>%component%</b> is now unconfirmed for this issue'] = 'Component <b>%component%</b> is now unconfirmed for this record';
	...
	$strings['Configure issue fields'] = 'Configure record fields';
	$strings['Configure issue types'] = 'Configure record types';
	...
	$strings['Copy issue type scheme'] = 'Copy record type scheme';
	...
	$strings['Could not assign issue to the any user or team because none were provided'] = 'Could not assign record to the any user or team because none were provided';
	$strings['Could not assign issue to the selected user because this users assigned issues limit is reached'] = 'Could not assign record to the selected user because this users assigned records limit is reached';
	$strings['Could not assign the issue to a milestone because none was provided'] = 'Could not assign the record to a milestone because none was provided';
	...
	$strings['Could not find this issue'] = 'Could not find this record';
	...
	$strings['Could not set issue priority because none was provided'] = 'Could not set record priority because none was provided';
	$strings['Could not set issue reproducability because none was provided'] = 'Could not set problem reproducability because none was provided';
	$strings['Could not set issue resolution because none was provided'] = 'Could not set record resolution because none was provided';
	$strings['Could not set issue status because none was provided'] = 'Could not set record status because none was provided';
	...
	$strings['%count% issues open of %total_count% issues total'] = '%count% records open of %total_count% records total';
	...
	$strings['Create a copy of this issue type scheme'] = 'Create a copy of this record type scheme';
	...
	$strings['Create a new related issue'] = 'Create a new related record';
	...
	$strings['Create new milestone from selected issues'] = 'Create new milestone from selected records';
	...
	$strings['Current user can have no more than %number% issues already assigned'] = 'Current user can have no more than %number% records already assigned';
	$strings['Current user can have no more than this many issues assigned'] = 'Current user can have no more than this many records assigned';
	...
	$strings['Custom issue fields'] = 'Custom record fields';
	...
	$strings['Data for issue import'] = 'Data for record import';
	...
	$strings['Date last updated - when was the issue last updated'] = 'Date last updated - when was the record last updated';
	$strings['Date reported'] = 'Date reported';
	$strings['Date reported - when was the issue reported'] = 'Date reported - when was the record reported';
	...
	$strings['Delete this issue type scheme'] = 'Delete this record type scheme';
	...
	$strings['Describe the issue in as much detail as possible. More is better.'] = 'Describe the record in as much detail as possible. More is better.';
	...
	$strings['Disable issue type for this scheme'] = 'Disable record type for this scheme';
	...
	$strings['Don\'t post system comments when an issue is updated'] = 'Don\'t post system comments when an record is updated';
	...
	$strings['Edition <b>%edition%</b> is no longer affected by this issue'] = 'Edition <b>%edition%</b> is no longer affected by this record';
	$strings['Edition <b>%edition%</b> is now affected by this issue'] = 'Edition <b>%edition%</b> is now affected by this record';
	$strings['Edition <b>%edition%</b> is now confirmed for this issue'] = 'Edition <b>%edition%</b> is now confirmed for this record';
	$strings['Edition <b>%edition%</b> is now %status%'] = 'Edition <b>%edition%</b> is now %status%';
	$strings['Edition <b>%edition%</b> is now unconfirmed for this issue'] = 'Edition <b>%edition%</b> is now unconfirmed for this record';
	...
	$strings['Either use the checkboxes and press the "%relate_these_issues%"-button below or click any issues in the list, and select an action.'] = 'Either use the checkboxes and press the "%relate_these_issues%"-button below or click any records in the list, and select an action.';
	...
	$strings['Enable issue type for this scheme'] = 'Enable record type for this scheme';
	...
	$strings['Enter a short, but descriptive summary of the issue here'] = 'Enter a short, but descriptive summary here';
	...
	$strings['Enter the link URL here, along with an optional description. Press "%attach_link%" to attach it to the issue.'] = 'Enter the link URL here, along with an optional description. Press "%attach_link%" to attach it to the record.';
	...
	$strings['Enter the steps necessary to reproduce the issue, as detailed as possible.'] = 'Enter the steps necessary to reproduce the problem, (preferably numbered like, 1. Did X, 2. Did Y, 3. Did Z, etc.).';
	...
	$strings['Enter time spent on this issue here. Use keywords such as "points", "hours", "days", "weeks" and "months" to describe your estimate'] = 'Enter time spent on this record here. Use keywords such as "points", "hours", "days", "weeks" and "months" to describe your estimate';
	...
	$strings['Estimate this issue'] = 'Estimate this record';
	...
	$strings['File issue'] = 'File record';
	...
	$strings['Find issue(s)'] = 'Find record(s)';
	$strings['Find issues for %project_name%'] = 'Find records for %project_name%';
	...
	$strings['Find related issues'] = 'Find related records';
	...
	$strings['Give someone access to this issue'] = 'Give someone access to this record';
	...
	$strings['Graph of closed vs open issues, past 15 days'] = 'Graph of closed vs open records, past 15 days';
	...
	$strings['Hold your mouse over an issuetype to see what it\'s used for'] = 'Hold your mouse over a recordtype to see what it\'s used for';
	...
	$strings['If you want to add a comment with the file, enter the comment here, and it will automatically be added to the issue with the file'] = 'If you want to add a comment with the file, enter the comment here, and it will automatically be added to the record with the file';
	...
	$strings['If you want to mark this issue as duplicate of another, existing issue, find the issue by entering details to search for, in the box above.'] = 'If you want to mark this record as duplicate of another, existing record, find the record by entering details to search for, in the box above.';
	...
	$strings['Information about the user working on this issue has been changed, from \'\'\'%previous_name%\'\'\' to \'\'\'%new_name%\'\'\'.'] = 'Information about the user working on this record has been changed, from \'\'\'%previous_name%\'\'\' to \'\'\'%new_name%\'\'\'.';
	...
	$strings['In this tab you can add/remove/edit issue type schemes. If you add a new issue type on the previous tab, you must associate it with an issue type scheme in this tab to get it to show up for users.'] = 'In this tab you can add/remove/edit record type schemes. If you add a new record type on the previous tab, you must associate it with a record type scheme in this tab to get it to show up for users.';
	$strings['In this tab you can add/remove/edit what issue types are available to issue type schemes. If you add a new issue type on this page, remember to associate it to an issue type scheme on the %issue_type_schemes% tab to get it to show up for users.'] = 'In this tab you can add/remove/edit what record types are available to record type schemes. If you add a new record type on this page, remember to associate it to a record type scheme on the %issue_type_schemes% tab to get it to show up for users.';
	$strings['In this tab you can edit issue type associations for this issue type scheme. Enable/disable available issue types, and set options such as reportable issue types and reportable/visible/required issue details.'] = 'In this tab you can edit record type associations for this record type scheme. Enable/disable available record types, and set options such as reportable record types and reportable/visible/required record details.';
	...
	$strings['Issue'] = 'Record';
	$strings['Issue access policy'] = 'Record access policy';
	$strings['Issue access policy updated'] = 'Record access policy updated';
	$strings['Issue closed %text%'] = 'Record closed %text%';
	$strings['Issue created'] = 'Record created';
	$strings['Issue dependancy removed'] = 'Record dependency removed';
	$strings['Issue description'] = 'Record description';
	$strings['Issue details'] = 'Record details';
	$strings['Issue fields'] = 'Record fields';
	$strings['Issue is created'] = 'Record is created';
	$strings['Issue %issue_no% no longer depends on the solution of this issue'] = 'Record %issue_no% no longer depends on the solution of this record';
	$strings['Issue %issue_no% - %title%'] = 'Record %issue_no% - %title%';
	$strings['Issue prefix'] = 'Record prefix';
	$strings['Issue reopened'] = 'Record reopened';
	$strings['Issues'] = 'Records';
	$strings['Issues closed'] = 'Records closed';
	$strings['Issues containing'] = 'Records containing';
	$strings['Issues in the workflow step on the left will have their workflow step changed to the one on the right. This will change the issue\'s status to the one assigned to the new step.'] = 'Records in the workflow step on the left will have their workflow step changed to the one on the right. This will change the record\'s status to the one assigned to the new step.';
	$strings['Issues not containing'] = 'Records not containing';
	$strings['Issues opened'] = 'Records opened';
	$strings['Issues per page'] = 'Records per page';
	$strings['Issues reported by me'] = 'Records created by me';
	$strings['Issues reported for %project_name% last 30 days'] = 'Records created for %project_name% last 30 days';
	$strings['Issues reported for %project_name% this month'] = 'Records created for %project_name% this month';
	$strings['Issues reported last 30 days'] = 'Records created last 30 days';
	$strings['Issues reported this month'] = 'Records created this month';
	$strings['Issue state'] = 'Record state';
	$strings['Issue state - whether an issue is open or closed'] = 'Record state - whether a record is open or closed';
	$strings['Issue title'] = 'Record title';
	$strings['Issuetype'] = 'Recordtype';
	$strings['Issue type'] = 'Record type';
	$strings['Issue type changed: %text%'] = 'Record type changed: %text%';
	$strings['Issue type created'] = 'Record type created';
	$strings['Issue type deleted'] = 'Record type deleted';
	...
	$strings['Issue type name'] = 'Record type name';
	$strings['Issue types'] = 'Record types';
	$strings['Issuetype scheme'] = 'Recordtype scheme';
	$strings['Issue type schemes'] = 'Record type schemes';
	$strings['Issue types with associated workflows: %number_of_associated_issuetypes%'] = 'Record types with associated workflows: %number_of_associated_issuetypes%';
	$strings['Issue type values'] = 'Record type values';
	$strings['Issue type - what kind of issue it is'] = 'Record type - what kind of record it is';
	$strings['Issue updated'] = 'Record updated';
	$strings['Issue updated from code repository'] = 'Record updated from code repository';
	...
	$strings['%item% is already affected by this issue'] = '%item% is already affected by this record';
	...
	$strings['Leave this input field blank to list all issues based on filters below'] = 'Leave this input field blank to list all records based on filters below';
	$strings['Lets you use arrow up / down in issue lists to navigate'] = 'Lets you use arrow up / down in record lists to navigate';
	...
	$strings['Mark as duplicate of another, existing issue'] = 'Mark as duplicate of another, existing record';
	...
	$strings['Mark issue as being worked on by the assigned user'] = 'Mark record as being worked on by the assigned user';
	$strings['Mark issue as duplicate of another, existing issue'] = 'Mark record as duplicate of another, existing record';
	$strings['Mark issue as no longer being worked on, and optionally add time spent'] = 'Mark record as no longer being worked on, and optionally add time spent';
	$strings['Mark issue as unique (no longer a duplicate) issue'] = 'Mark record as unique (no longer a duplicate) record';
	$strings['Mark selected issues as child issues of this issue'] = 'Mark selected records as child records of this record';
	$strings['Mark selected issues as parent issues of this issue'] = 'Mark selected records as parent records of this record';
	$strings['Max number of assigned issues'] = 'Max number of assigned records';
	...
	$strings['Milestone details have changed. To see the updated list of issues, click the "Show issues" icon'] = 'Milestone details have changed. To see the updated list of records, click the "Show records" icon';
	$strings['Milestone isn\'t visible for this issuetype / product combination'] = 'Milestone isn\'t visible for this recordtype / product combination';
	...
	$strings['Milestone - which milestone an issue is targetted for'] = 'Milestone - which milestone an record is targetted for';
	...
	$strings['Most voted for issues'] = 'Most voted for records';
	$strings['Most voted-for issues'] = 'Most voted-for records';
	$strings['Most voted issues for %project_name%'] = 'Most voted records for %project_name%';
	$strings['Move issue'] = 'Move record';
	$strings['%move_issue% or %cancel%'] = '%move_issue% or %cancel%';
	$strings['Move issue to'] = 'Move record to';
	$strings['Move issue to a different project'] = 'Move record to a different project';
	$strings['Move issue to another project'] = 'Move record to another project';
	...
	$strings['No issues assigned to this milestone'] = 'No records assigned to this milestone';
	$strings['No issues found matching your query'] = 'No records found matching your query';
	$strings['No issues in this list'] = 'No records in this list';
	$strings['No issues matched your search. Please try again with different search terms.'] = 'No records matched your search. Please try again with different search terms.';
	$strings['No issues of this type has been posted yet'] = 'No records of this type has been posted yet';
	$strings['No issues recently commented'] = 'No records recently commented';
	$strings['No issues were found'] = 'No records were found';
	...
	$strings['Noone'] = 'Noone';
	$strings['Noone else can see this issue'] = 'Noone else can see this record';
	$strings['No other articles links to this article'] = 'No other articles links to this article';
	$strings['No other issues depends on this issue'] = 'No other records depends on this record';
	...
	$strings['No scrum-compatible issue types found'] = 'No scrum-compatible record types found';
	...
	$strings['Notify me when an issue assigned to one of my projects is updated or created'] = 'Notify me when a record assigned to one of my projects is updated or created';
	$strings['Notify me when an issue assigned to one of my team projects is updated or created'] = 'Notify me when a record assigned to one of my team projects is updated or created';
	$strings['Notify me when an issue assigned to one of my teams is updated or created'] = 'Notify me when a record assigned to one of my teams is updated or created';
	$strings['Notify me when an issue I commented on gets updated'] = 'Notify me when a record I commented on gets updated';
	$strings['Notify me when an issue I\'m assigned to gets updated or created'] = 'Notify me when a record I\'m assigned to gets updated or created';
	$strings['Notify me when an issue I posted gets updated or created'] = 'Notify me when a record I posted gets updated or created';
	$strings['Notify me when I update or create an issue'] = 'Notify me when I update or create a record';
	...
	$strings['No workflow step matches this issue after changes are saved. Please either use the workflow action buttons, or make sure your changes are valid within the current project workflow for this issue type.'] = 'No workflow step matches this record after changes are saved. Please either use the workflow action buttons, or make sure your changes are valid within the current project workflow for this record type.';
	...
	$strings['%number_of% issue(s)'] = '%number_of% record(s)';
	$strings['Number of issues'] = 'Number of records';
	$strings['%number_of% issue(s), %hours% hrs, %points% pts'] = '%number_of% record(s), %hours% hrs, %points% pts';
	$strings['%number_of_issues% issues per page'] = '%number_of_issues% records per page';
	$strings['Number of issues per:'] = 'Number of records per:';
	...
	$strings['%number_of% issues selected'] = '%number_of% records selected';
	...
	$strings['Number of user comments on this issue'] = 'Number of user comments on this record';
	$strings['%number_of% weeks'] = '%number_of% weeks';
	$strings['%num_closed% issue(s) closed of %num_assigned% assigned'] = '%num_closed% record(s) closed of %num_assigned% assigned';
	...
	$strings['%num% issue(s) found'] = '%num% record(s) found';
	$strings['%num% issue(s) updated'] = '%num% record(s) updated';
	...
	$strings['One or more errors occured when trying to file your issue'] = 'One or more errors occured when trying to file your record';
	$strings['One or more teams were invalid'] = 'One or more teams were invalid';
	$strings['%on_frontpage_comma_show% list of open issues'] = '%on_frontpage_comma_show% list of open records';
	$strings['%on_frontpage_comma_show% only project information'] = '%on_frontpage_comma_show% only project information';
	$strings['%on_frontpage_comma_show% status per issue types'] = '%on_frontpage_comma_show% status per record types';
	...
	$strings['Only notify me once per issue until I open the issue'] = 'Only notify me once per record until I open the record';
	...
	$strings['Only using The Bug Genie to track issues for one project?'] = 'Only using The Bug Genie to track records for one project?';
	...
	$strings['Open issues'] = 'Open records';
	$strings['Open issues assigned to me'] = 'Open records assigned to me';
	$strings['Open issues assigned to my teams'] = 'Open records assigned to my teams';
	$strings['Open issues assigned to you'] = 'Open records assigned to you';
	$strings['Open issues assigned to your teams'] = 'Open records assigned to your teams';
	$strings['Open issues for %project_name%'] = 'Open records for %project_name%';
	$strings['Open issues for this project'] = 'Open records for this project';
	$strings['Open issues owned by me'] = 'Open records owned by me';
	$strings['Open issues per category'] = 'Open records per category';
	$strings['Open issues per priority level'] = 'Open records per priority level';
	$strings['Open issues per reproducability level'] = 'Open records per reproducability level';
	$strings['Open issues per resolution'] = 'Open records per resolution';
	$strings['Open issues per status type'] = 'Open records per status type';
	...
	$strings['Owned by team - which team owns an issue'] = 'Owned by team - which team owns a record';
	$strings['Owned by user'] = 'Owned by user';
	$strings['Owned by user - which user owns an issue'] = 'Owned by user - which user owns a record';
	...
	$strings['Percent completed isn\'t visible for this issuetype / product combination'] = 'Percent completed isn\'t visible for this recordtype / product combination';
	$strings['Percent completed: %text%'] = 'Percent completed: %text%';
	$strings['Perform the following workflow transition on these issues'] = 'Perform the following workflow transition on these records';
	$strings['Perform workflow step'] = 'Perform workflow step';
	$strings['Permanently delete this issue'] = 'Permanently delete this record';
	$strings['Permanently delete this issue?'] = 'Permanently delete this record?';
	...
	$strings['Pick a planning color for this issue'] = 'Pick a planning color for this record';
	...
	$strings['Please be aware that moving this issue to a different project will reset details such as status, category, etc., and may also make some fields invisible, depending on the issue type configuration for that project. The issue will also be renumbered.'] = 'Please be aware that moving this record to a different project will reset details such as status, category, etc., and may also make some fields invisible, depending on the record type configuration for that project. The record will also be renumbered.';
	$strings['Please confirm'] = 'Please confirm';
	$strings['Please confirm that you want to delete this issue type scheme.'] = 'Please confirm that you want to delete this record type scheme.';
	...
	$strings['Please enter how many percent complete the issue already is'] = 'Please enter how many percent complete the record already is';
	$strings['Please enter some details to search for, and then select the matching issues to relate them'] = 'Please enter some details to search for, and then select the matching records to relate them';
	...
	$strings['Please enter the name of the new issue type scheme'] = 'Please enter the name of the new record type scheme';
	...
	$strings['Please enter time already spent working on this issue'] = 'Please enter time already spent working on this record';
	$strings['Please enter your current password'] = 'Please enter your current password';
	$strings['Please file the issue before attaching a file'] = 'Please file the record before attaching a file';
	$strings['Please file the issue before attaching a link'] = 'Please file the record before attaching a link';
	...
	$strings['Please log in to bookmark issues'] = 'Please log in to bookmark records';
	$strings['Please provide an issue number'] = 'Please provide a record number';
	$strings['Please provide a valid action for this issue type'] = 'Please provide a valid action for this record type';
	$strings['Please provide a valid action for this issue type / scheme'] = 'Please provide a valid action for this record type / scheme';
	$strings['Please provide a valid id'] = 'Please provide a valid id';
	$strings['Please provide a valid issue number and a valid related issue number'] = 'Please provide a valid record number and a valid related record number';
	$strings['Please provide a valid issue type'] = 'Please provide a valid record type';
	$strings['Please provide a valid name'] = 'Please provide a valid name';
	$strings['Please provide a valid name for the issue type'] = 'Please provide a valid name for the record type';
	...
	$strings['Please select an issue type from this list'] = 'Please select a record type from this list';
	$strings['Please select at least one issue'] = 'Please select at least one record';
	...
	$strings['Please select the type and item you wish to add as affected by this issue.'] = 'Please select the type and item you wish to add as affected by this record.';
	...
	$strings['Please triage the reported issue, so the user pain score can be properly calculated'] = 'Please triage the reported record, so the user pain score can be properly calculated';
	...
	$strings['Please wait while updating issue type'] = 'Please wait while updating record type';
	...
	$strings['Posted by user - which user posted the issue'] = 'Posted by user - which user posted the record';
	...
	$strings['Press "Enter" twice to find issues matching your query'] = 'Press "Enter" twice to find records matching your query';
	...
	$strings['Priority - how high the issue is prioritised'] = 'Priority - how high the record is prioritised';
	$strings['Priority is any of these values: %priorities%'] = 'Priority is any of these values: %priorities%';
	$strings['Priority isn\'t visible for this issuetype / product combination'] = 'Priority isn\'t visible for this recordtype / product combination';
	...
	$strings['"%project_name%" issues'] = '"%project_name%" records';
	...
	$strings['Read-only access: "Issue fields" configuration page'] = 'Read-only access: "Record fields" configuration page';
	$strings['Read-only access: "Issue types" configuration page'] = 'Read-only access: "Record types" configuration page';
	...
	$strings['Read + write access: "Issue fields" configuration page'] = 'Read + write access: "Record fields" configuration page';
	$strings['Read + write access: "Issue types" configuration page'] = 'Read + write access: "Record types" configuration page';
	...
	$strings['Recent issues: %issuetype%'] = 'Recent records: %issuetype%';
	...
	$strings['Related issues and tasks (%count%)'] = 'Related records and tasks (%count%)';
	$strings['Relate these issues'] = 'Relate these records';
	$strings['Relate to an existing issue'] = 'Relate to an existing record';
	$strings['Release'] = 'Release';
	$strings['Release <b>%build%</b> is no longer affected by this issue'] = 'Release <b>%build%</b> is no longer affected by this record';
	$strings['Release <b>%build%</b> is now affected by this issue'] = 'Release <b>%build%</b> is now affected by this record';
	$strings['Release <b>%build%</b> is now confirmed for this issue'] = 'Release <b>%build%</b> is now confirmed for this record';
	$strings['Release <b>%build%</b> is now %status%'] = 'Release <b>%build%</b> is now %status%';
	$strings['Release <b>%build%</b> is now unconfirmed for this issue'] = 'Release <b>%build%</b> is now unconfirmed for this record';
	...
	$strings['Reload issues'] = 'Reload records';
	...
	$strings['Remove issuetype'] = 'Remove recordtype';
	$strings['Remove %itemname%?'] = 'Remove %itemname%?';
	$strings['Remove relation to issue %itemname%?'] = 'Remove relation to record %itemname%?';
	...
	$strings['Report an issue'] = 'Create Record';
	...
	$strings['Reproducability - how often you can reproduce the issue'] = 'Reproducability - how often you can reproduce the problem';
	...
	$strings['Reproducability isn\'t visible for this issuetype / product combination'] = 'Reproducability isn\'t visible for this recordtype / product combination';
	...
	$strings['Resolution isn\'t visible for this issuetype / product combination'] = 'Resolution isn\'t visible for this recordtype / product combination';
	...
	$strings['Resolution - the issue\'s resolution'] = 'Resolution - the record\'s resolution';
	...
	$strings['Row %row% column %col%: issue type does not exist'] = 'Row %row% column %col%: record type does not exist';
	$strings['Row %row% column %col%: issuetype scheme does not exist'] = 'Row %row% column %col%: recordtype scheme does not exist';
	...
	$strings['Row %row% column %col%: this project does not support issues of this type (%type%)'] = 'Row %row% column %col%: this project does not support records of this type (%type%)';
	...
	$strings['See %about_issue_prefix% for an explanation about issue prefixes'] = 'See %about_issue_prefix% for an explanation about record prefixes';
	...
	$strings['See %num% more issues ...'] = 'See %num% more records ...';
	...
	$strings['Select a new issue type'] = 'Select a new record type';
	...
	$strings['Selecting a color makes the issue easily recognizable in the planning view'] = 'Selecting a color makes the record easily recognizable in the planning view';
	$strings['Selecting a color makes the story easily recognizable'] = 'Selecting a color makes the story easily recognizable';
	$strings['Select issue type'] = 'Select record type';
	...
	$strings['Select what kind of issue type this is'] = 'Select what kind of record type this is';
	...
	$strings['Set issue milestone'] = 'Set record milestone';
	$strings['Set issue percent completed'] = 'Set record percent completed';
	$strings['Set issue priority'] = 'Set record priority';
	$strings['Set issue reproducability'] = 'Set problem reproducability';
	$strings['Set issue resolution'] = 'Set record resolution';
	$strings['Set issue status'] = 'Set record status';
	$strings['Set issue type'] = 'Set record type';
	...
	$strings['Settings related to issues and issue reporting'] = 'Settings related to records and record reporting';
	...
	$strings['Severity - how serious the issue is'] = 'Severity - how serious the problem is';
	...
	$strings['Show / edit issue type associations'] = 'Show / edit record type associations';
	$strings['Show / edit issue type settings'] = 'Show / edit record type settings';
	...
	$strings['Showing "bug report" issues sorted by user pain, threshold set at %threshold%'] = 'Showing "bug report" problems sorted by user pain, threshold set at %threshold%';
	$strings['Showing issues ordered by number of votes'] = 'Showing records ordered by number of votes';
	...
	$strings['Show issues'] = 'Show records';
	$strings['Show issues I\'ve reported'] = 'Show records I\'ve reported';
	...
	$strings['Show my issues'] = 'Show my records';
	$strings['Show newly created users'] = 'Show newly created users';
	$strings['Show open issues assigned to me'] = 'Show open records assigned to me';
	$strings['Show open issues assigned to my teams'] = 'Show open records assigned to my teams';
	...
	$strings['Specify additional information by clicking the links below before submitting your issue'] = 'Specify additional information by clicking the links below before submitting your record';
	...
	$strings['Specify the target milestone for this issue'] = 'Specify the target milestone for this record';
	...
	$strings['Specify who can set this value for issues.'] = 'Specify who can set this value for records.';
	...
	$strings['Status - what status an issue has'] = 'Status - what status a record has';
	...
	$strings['Steps to reproduce the issue'] = 'Steps to reproduce the record';
	$strings['Steps to reproduce this issue'] = 'Steps to reproduce this record';
	...
	$strings['%teamname% has been working on this issue since %time%'] = '%teamname% has been working on this record since %time%';
	...
	$strings['Textarea in issue main area'] = 'Textarea in record main area';
	$strings['Textarea (small) in issue details list'] = 'Textarea (small) in record details list';
	...
	$strings['The administrator has disabled reporting issues for this project'] = 'The administrator has disabled reporting records for this project';
	...
	$strings['%thebuggenie%, <b>friendly</b> issue tracking since 2002'] = '%thebuggenie%, <b>friendly</b> record tracking since 2002';
	$strings['The Bug Genie can check email accounts and create issues from incoming emails. Set up a new account here, and check the %online_documentation% for more information.'] = 'The Bug Genie can check email accounts and create records from incoming emails. Set up a new account here, and check the %online_documentation% for more information.';
	$strings['The Bug Genie can load sample data for you, so you can play around without having to use your own data. Press the button below to import sample projects and issues.'] = 'The Bug Genie can load sample data for you, so you can play around without having to use your own data. Press the button below to import sample projects and records.';
	...
	$strings['The Bug Genie is an issue tracking system with a strong focus on being friendly &ndash; both for regular users and power users'] = 'The Bug Genie is a record tracking system with a strong focus on being friendly &ndash; both for regular users and power users';
	...
	$strings['The file was attached to this issue'] = 'The file was attached to this record';
	...
	$strings['The following actions will be applied to the issue during this transition.'] = 'The following actions will be applied to the record during this transition.';
	...
	$strings['The following issues are duplicates of this issue:'] = 'The following records are duplicates of this record:';
	$strings['The following issues matched your search'] = 'The following records matched your search';
	$strings['The following issue was reported: %issue_title%'] = 'The following record was reported: %issue_title%';
	...
	$strings['The issue has been (re-)estimated, from \'\'\'%previous_time%\'\'\' to \'\'\'%new_time%\'\'\'.'] = 'The record has been (re-)estimated, from \'\'\'%previous_time%\'\'\' to \'\'\'%new_time%\'\'\'.';
	$strings['The issue has been updated'] = 'The record has been updated';
	$strings['The issues are no longer related'] = 'The records are no longer related';
	$strings['The issue\'s poster has been changed, from \'\'\'%previous_name%\'\'\' to \'\'\'%new_name%\'\'\'.'] = 'The record\'s poster has been changed, from \'\'\'%previous_name%\'\'\' to \'\'\'%new_name%\'\'\'.';
	$strings['The issue type details were updated'] = 'The record type details were updated';
	$strings['The issue type has been updated, from \'\'\'%previous_type%\'\'\' to \'\'\'%new_type%\'\'\'.'] = 'The record type has been updated, from \'\'\'%previous_type%\'\'\' to \'\'\'%new_type%\'\'\'.';
	$strings['The issuetype scheme was deleted'] = 'The recordtype scheme was deleted';
	$strings['The issue type was updated'] = 'The record type was updated';
	$strings['The issue was moved'] = 'The record was moved';
	$strings['The issue was not moved, since the project is the same'] = 'The record was not moved, since the project is the same';
	$strings['The issue was updated with the following change(s):%list_of_changes%'] = 'The record was updated with the following change(s):%list_of_changes%';
	$strings['The label is shown to the user in issue view'] = 'The label is shown to the user in record view';
	...
	$strings['The project lead will automatically be assigned issues. This can be overriden by component and edition leads, as well as manually specifing when creating an issue.'] = 'The project lead will automatically be assigned records. This can be overriden by component and edition leads, as well as manually specifing when creating a record.';
	$strings['The project this issue belongs to has been archived, and so this issue is now read only'] = 'The project this record belongs to has been archived, and so this record is now read only';
	...
	$strings['There are no code checkins for this issue'] = 'There are no code checkins for this record';
	...
	$strings['There are no workflow transitions that can be applied to all these issues. Try selecting fewer issues, or issues that are currently at the same (or similar) workflow step(s).'] = 'There are no workflow transitions that can be applied to all these records. Try selecting fewer records, or records that are currently at the same (or similar) workflow step(s).';
	...
	$strings['There is nothing attached to this issue'] = 'There is nothing attached to this record';
	$strings['The related issue was added'] = 'The related record was added';
	...
	$strings['There was an error creating this issue'] = 'There was an error creating this record';
	...
	$strings['There was an error trying to move this issue to the next step in the workflow'] = 'There was an error trying to move this record to the next step in the workflow';
	$strings['There was an error trying to save changes to this issue'] = 'There was an error trying to save changes to this record';
	...
	$strings['The transition could not be applied to issue %issue_number% because of %errors%'] = 'The transition could not be applied to record %issue_number% because of %errors%';
	...
	$strings['The user is redirected to the reported issue after it has been reported'] = 'The user is redirected to the reported record after it has been reported';
	...
	$strings['This action cannot be reverted. Note: this will not modify any issues affected by this search'] = 'This action cannot be reverted. Note: this will not modify any records affected by this search';
	...
	$strings['This action is not available when this issue is closed'] = 'This action is not available when this record is closed';
	...
	$strings['This commit affects no issues'] = 'This commit affects no records';
	$strings['This commit only affects issues you do not hae access to'] = 'This commit only affects records you do not hae access to';
	$strings['This component already exists for this project'] = 'This component already exists for this project';
	$strings['This component is not affected by this issue'] = 'This component is not affected by this record';
	$strings['This could be because you the issue doesn\'t exist, has been deleted or you don\'t have permission to see it'] = 'This could be because you the record doesn\'t exist, has been deleted or you don\'t have permission to see it';
	...
	$strings['This edition is not affected by this issue'] = 'This edition is not affected by this record';
	...
	$strings['This issue'] = 'This record';
	$strings['This issue cannot be updated'] = 'This record cannot be updated';
	$strings['This issue does not depend on any other issues'] = 'This record does not depend on any other records';
	$strings['This issue does not exist'] = 'This record does not exist';
	$strings['This issue has been changed since you started editing it'] = 'This record has been changed since you started editing it';
	$strings['This issue has been closed'] = 'This record has been closed';
	$strings['This issue has been closed with status "%status_name%" and resolution "%resolution%".'] = 'This record has been closed with status "%status_name%" and resolution "%resolution%".';
	$strings['This issue has been deleted'] = 'This record has been deleted';
	$strings['This issue has been reopened'] = 'This record has been reopened';
	$strings['This issue has no duplicates'] = 'This record has no duplicates';
	$strings['This issue has %num% attachments'] = 'This record has %num% attachments';
	$strings['This issue is a duplicate of issue %link_to_duplicate_issue%'] = 'This record is a duplicate of record %link_to_duplicate_issue%';
	$strings['This issue is blocking the next release'] = 'This record is blocking the next release';
	$strings['This issue is no longer blocking the next release'] = 'This record is no longer blocking the next release';
	$strings['This issue is not valid for this project'] = 'This record is not valid for this project';
	$strings['This issue is now blocking the next release'] = 'This record is now blocking the next release';
	$strings['This issue no longer depends on the solution of issue %issue_no%'] = 'This record no longer depends on the solution of record %issue_no%';
	$strings['This issue\'s description has been changed'] = 'This record\'s description has been changed';
	$strings['This issue\'s progression has been updated to %percent_completed% percent completed.'] = 'This record\'s progression has been updated to %percent_completed% percent completed.';
	$strings['This issue\'s reproduction steps has been changed'] = 'This record\'s reproduction steps has been changed';
	$strings['This issue\'s title has been changed'] = 'This record\'s title has been changed';
	...
	$strings['This is the full URL to the issue tracker, used when sending emails via the command line interface. If this isn\'t configured, you will not be able to send emails via the CLI for this scope.'] = 'This is the full URL to the record tracker, used when sending emails via the command line interface. If this isn\'t configured, you will not be able to send emails via the CLI for this scope.';
	...
	$strings['This is the user pain value for this issue'] = 'This is the user pain value for this record';
	...
	$strings['This milestone also includes issues you do not have access to'] = 'This milestone also includes records you do not have access to';
	...
	$strings['This page shows all the issuetype / workflow associations for the selected workflow scheme'] = 'This page shows all the recordtype / workflow associations for the selected workflow scheme';
	...
	$strings['This release is not affected by this issue'] = 'This release is not affected by this record';
	...
	$strings['This setting is used to display issues, comments and more in your local timezone.'] = 'This setting is used to display records, comments and more in your local timezone.';
	...
	$strings['This transition will be applied to %count% selected issues'] = 'This transition will be applied to %count% selected records';
	...
	$strings['This user has not reported any issues yet'] = 'This user has not reported any records yet';
	$strings['This user has reported %issues% issue(s)'] = 'This user has reported %issues% record(s)';
	...
	$strings['This will also remove the value of this custom field from all issues, along with any possible options this field can take.'] = 'This will also remove the value of this custom field from all records, along with any possible options this field can take.';
	...
	$strings['Time spent on this issue'] = 'Time spent on this record';
	$strings['Time spent on this issue, from \'\'\'%previous_time%\'\'\' to \'\'\'%new_time%\'\'\'.'] = 'Time spent on this record, from \'\'\'%previous_time%\'\'\' to \'\'\'%new_time%\'\'\'.';
	$strings['Time spent: %text%'] = 'Time spent: %text%';
	$strings['Time spent working on the issue'] = 'Time spent working on the record';
	$strings['Title'] = 'Title';
	...
	$strings['To keep the comment trail clean in issues, you can select not to post system comments when an issue is updated.'] = 'To keep the comment trail clean in records, you can select not to post system comments when a record is updated.';
	...
	$strings['Total number of issues in this group: %number%'] = 'Total number of records in this group: %number%';
	$strings['Total number of issues (open / closed)'] = 'Total number of records (open / closed)';
	$strings['Total number of issues per category'] = 'Total number of records per category';
	$strings['Total number of issues per priority level'] = 'Total number of records per priority level';
	$strings['Total number of issues per reproducability level'] = 'Total number of records per reproducability level';
	$strings['Total number of issues per resolution'] = 'Total number of records per resolution';
	$strings['Total number of issues per status type'] = 'Total number of records per status type';
	...
	$strings['Type of issue'] = 'Type of record';
	$strings['Unactivated users'] = 'Unactivated users';
	$strings['Unarchive project'] = 'Unarchive project';
	$strings['Unassigned issues / backlog'] = 'Unassigned records / backlog';
	...
	$strings['Unknown issuetype'] = 'Unknown recordtype';
	$strings['Unknown issue type'] = 'Unknown record type';
	...
	$strings['Update issue access policy'] = 'Update record access policy';
	$strings['Update issue details'] = 'Update record details';
	...
	$strings['%user% has been working on this issue since %time%'] = '%user% has been working on this record since %time%';
	...
	$strings['Users cannot report new issues with this issue type, but may choose it when editing an issue'] = 'Users cannot report new records with this record type, but may choose it when editing a record';
	...
	$strings['Users can report new issues with this issue type'] = 'Users can report new records with this record type';
	...
	$strings['Users or teams who can see this issue'] = 'Users or teams who can see this record';
	...
	$strings['Users see this description when choosing an issue type to report'] = 'Users see this description when choosing a record type to report';
	...
	$strings['What\'s the issue?'] = 'Types of Project Records';
	...
	$strings['When you are satisfied, click the %file_issue% button to file your issue'] = 'When you are satisfied, click the %file_issue% button to file your record';
	...
	$strings['Whether or not developers can change details on an issue without marking themselves as working on the issue'] = 'Whether or not developers can change details on a record without marking themselves as working on the record';
	...
	$strings['Whether this issue type is enabled for reporting or not'] = 'Whether this record type is enabled for reporting or not';
	$strings['Whether to forward the user to the reported issue after it has been reported'] = 'Whether to forward the user to the reported record after it has been reported';
	...
	$strings['With selected issue(s): %action%'] = 'With selected record(s): %action%';
	...
	$strings['You are adding an issue to %milestone_name%'] = 'You are adding a record to %milestone_name%';
	$strings['You are adding an issue to release %release_name%'] = 'You are adding a record to release %release_name%';
	...
	$strings['You are involved with this issue and may be notified whenever it is updated or changed'] = 'You are involved with this record and may be notified whenever it is updated or changed';
	...
	$strings['You are not allowed to perform any workflow transitions on this issue'] = 'You are not allowed to perform any workflow transitions on this record';
	$strings['You are not allowed to relate issues'] = 'You are not allowed to relate records';
	...
	$strings['You can not attach links to this issue'] = 'You can not attach links to this record';
	...
	$strings['You can not remove items from this issue'] = 'You can not remove items from this record';
	...
	$strings['You can only apply workflow transitions on issues in the same project.'] = 'You can only apply workflow transitions on records in the same project.';
	$strings['You can only import sample projects once'] = 'You can only import sample projects once';
	$strings['You can optionally set a user to automatically assign issues filed against this component to. This setting is independant of the save button below.'] = 'You can optionally set a user to automatically assign records filed against this component to. This setting is independant of the save button below.';
	...
	$strings['You don\'t have access to estimate the issue'] = 'You don\'t have access to estimate the record';
	...
	$strings['You don\'t have access to specify how many percent complete the issue is'] = 'You don\'t have access to specify how many percent complete the record is';
	$strings['You don\'t have access to specify reproducability'] = 'You don\'t have access to specify reproducability';
	$strings['You don\'t have access to specify time already spent working on the issue'] = 'You don\'t have access to specify time already spent working on the record';
	$strings['You don\'t have access to update the issue access policy'] = 'You don\'t have access to update the record access policy';
	...
	$strings['You have been working on this issue since %time%'] = 'You have been working on this record since %time%';
	$strings['You have changed this issue, but haven\'t saved your changes yet. To save it, press the %save_changes% button to the right'] = 'You have changed this record, but haven\'t saved your changes yet. To save it, press the %save_changes% button to the right';
	...
	$strings['You have specified an issue that can\'t be shown'] = 'You have specified a record that can\'t be shown';
	...
	$strings['You have to select a valid issue type'] = 'You have to select a valid record type';
	...
	$strings['Your issues'] = 'My records';
