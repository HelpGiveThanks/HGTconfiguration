...
<?php //Only allow Admin users to move issues. ?>
...
<?php //Added comment to inform users that only Admin users can move issues. ?>
     <?php echo __(' Only Admin users can move issues.  Please post a comment for Admin users explaining why this issue needs to be moved.'); ?></div><div style="text-align: center; padding-top: 5px;"> 
   <a href="javascript:void(0)" onclick="TBG.Main.Helpers.Backdrop.reset();"><?php echo __('cancel'); ?></a></div>
     <br><br>
          <div style="text-align: right;">
     <?php echo __('(Message  ...pm/modules/main/templates/_moveissue.inc.php)'); ?>
          </div>
<?php endif; ?>
